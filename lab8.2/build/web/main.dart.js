...
define('zapp_user_main', ['dart_sdk', 'flutter_sdk'], (function load__zapp_user_main(dart_sdk, flutter_sdk) {
  ...
  var T = {
    ...
    ListOfNews: () => (T.ListOfNews = dart.constFn(core.List$(main.News)))(),
    FutureBuilderOfListOfNews: () => (T.FutureBuilderOfListOfNews = dart.constFn(async$.FutureBuilder$(T.ListOfNews())))(),
    AsyncSnapshotOfListOfNews: () => (T.AsyncSnapshotOfListOfNews = dart.constFn(async$.AsyncSnapshot$(T.ListOfNews())))(),
    BuildContextAndAsyncSnapshotOfListOfNewsToWidget: () => (T.BuildContextAndAsyncSnapshotOfListOfNewsToWidget = dart.constFn(dart.fnType(framework.Widget, [framework.BuildContext, T.AsyncSnapshotOfListOfNews()])))(),
    ...
    dynamicToNews: () => (T.dynamicToNews = dart.constFn(dart.fnType(main.News, [dart.dynamic])))(),
  ...
  dart.defineLazy(CT, {
    ...
    get C1() {
      return C[1] = dart.const({
        ...
        [Text_style]: null,
        [Text_textSpan]: null,
        [Text_data]: "Новостная лента КубГАУ"
      });
    },
    get C3() {
      return C[3] = dart.const({
        ...
        [Text_style]: null,
        [Text_textSpan]: null,
        [Text_data]: "Ошибка загрузки данных!"
      });
    },
    get C4() {
  ...
  var id$ = dart.privateName(main, "News.id");
  var title$ = dart.privateName(main, "News.title");
  var body$ = dart.privateName(main, "News.body");
  var date$ = dart.privateName(main, "News.date");
  var imageUrl$ = dart.privateName(main, "News.imageUrl");
  main.News = class News extends core.Object {
    get id() {
      return this[id$];
    }
    set id(value) {
    ...
    static ['_#new#tearOff'](opts) {
      ...
      return new main.News.new({id: id, title: title, body: body, date: date, imageUrl: imageUrl});
    }
    static fromJson(json) {
      return new main.News.new({id: core.int.as(json[$_get]("id")), title: core.String.as(json[$_get]("title")), body: core.String.as(json[$_get]("body")), date: core.String.as(json[$_get]("date")), imageUrl: core.String.as(json[$_get]("imageUrl"))});
    }
    static ['_#fromJson#tearOff'](json) {
      return main.News.fromJson(json);
    }
  };
  (main.News.new = function(opts) {
    let id = opts && 'id' in opts ? opts.id : null;
    let title = opts && 'title' in opts ? opts.title : null;
    let body = opts && 'body' in opts ? opts.body : null;
    let date = opts && 'date' in opts ? opts.date : null;
    ...
    ;
  }).prototype = main.News.prototype;
  dart.addTypeTests(main.News);
  dart.addTypeCaches(main.News);
  dart.setStaticMethodSignature(main.News, () => ['fromJson']);
  dart.setLibraryUri(main.News, I[0]);
  dart.setFieldSignature(main.News, () => ({
    __proto__: dart.getFields(main.News.__proto__),
  ...
  main.MyHomePage = class MyHomePage extends framework.StatelessWidget {
    ...
    build(context) {
      return new scaffold.Scaffold.new({appBar: new app_bar.AppBar.new({title: C[1] || CT.C1}), body: new (T.FutureBuilderOfListOfNews()).new({future: main.fetchNews(client$.Client.new()), builder: dart.fn((context, snapshot) => {
            if (snapshot.hasError) {
              return C[2] || CT.C2;
            } else if (snapshot.hasData) {
              return new main.NewsList.new({newsList: dart.nullCheck(snapshot.data)});
            } else {
              return C[5] || CT.C5;
            }
          }, T.BuildContextAndAsyncSnapshotOfListOfNewsToWidget())})});
    }
  };
  ...
  var newsList$ = dart.privateName(main, "NewsList.newsList");
  var EdgeInsets_bottom = dart.privateName(edge_insets, "EdgeInsets.bottom");
  var EdgeInsets_right = dart.privateName(edge_insets, "EdgeInsets.right");
  var EdgeInsets_top = dart.privateName(edge_insets, "EdgeInsets.top");
  var EdgeInsets_left = dart.privateName(edge_insets, "EdgeInsets.left");
  main.NewsList = class NewsList extends framework.StatelessWidget {
    get newsList() {
    ...
    static ['_#new#tearOff'](opts) {
      let key = opts && 'key' in opts ? opts.key : null;
      let newsList = opts && 'newsList' in opts ? opts.newsList : null;
      return new main.NewsList.new({key: key, newsList: newsList});
    }
    build(context) {
      return new scroll_view.ListView.builder({itemCount: this.newsList[$length], itemBuilder: dart.fn((context, index) => {
          let news = this.newsList[$_get](index);
          return new card.Card.new({margin: C[8] || CT.C8, child: new list_tile.ListTile.new({contentPadding: C[9] || CT.C9, leading: new image.Image.network(news.imageUrl, {width: 100, height: 100, fit: box_fit.BoxFit.cover}), title: new text.Text.new(news.title, {style: new text_style.TextStyle.new({fontWeight: ui.FontWeight.bold})}), subtitle: new text.Text.new(news.body), trailing: new text.Text.new(news.date), onTap: dart.fn(() => {
              }, T.VoidTovoid())})});
        }, T.BuildContextAndintToCard())});
    }
  };
  (main.NewsList.new = function(opts) {
    let key = opts && 'key' in opts ? opts.key : null;
    let newsList = opts && 'newsList' in opts ? opts.newsList : null;
    this[newsList$] = newsList;
    main.NewsList.__proto__.new.call(this, {key: key});
    ;
  }).prototype = main.NewsList.prototype;
  dart.addTypeTests(main.NewsList);
  dart.addTypeCaches(main.NewsList);
  dart.setMethodSignature(main.NewsList, () => ({
    __proto__: dart.getMethods(main.NewsList.__proto__),
    build: dart.fnType(framework.Widget, [framework.BuildContext])
  }));
  dart.setLibraryUri(main.NewsList, I[0]);
  dart.setFieldSignature(main.NewsList, () => ({
    __proto__: dart.getFields(main.NewsList.__proto__),
    newsList: dart.finalFieldType(core.List$(main.News))
  }));
  main.MyApp = class MyApp extends framework.StatelessWidget {
    ...
    build(context) {
      return new app.MaterialApp.new({title: "Новостная лента КубГАУ", theme: theme_data.ThemeData.new({primarySwatch: colors.Colors.blue}), home: C[10] || CT.C10});
    }
  };
  ...
  main.fetchNews = function fetchNews(client) {
    return async.async(T.ListOfNews(), function* fetchNews() {
      let response = (yield client.get(core.Uri.parse("https://kubsau.ru/api/getNews.php?key=6df2f5d38d4e16b5a923a6d4873e2ee295d0ac90")));
      if (response.statusCode === 200) {
        return main.parseNews(response.body);
      } else {
        dart.throw(core.Exception.new("Ошибка загрузки новостей"));
      }
    });
  };
  main.parseNews = function parseNews(responseBody) {
    let parsed = dart.dgsend(convert.jsonDecode(responseBody), [T.MapOfString$dynamic()], 'cast', []);
    return T.ListOfNews().as(dart.dsend(dart.dgsend(parsed, [main.News], 'map', [dart.fn(json => main.News.fromJson(T.MapOfString$dynamic().as(json)), T.dynamicToNews())]), 'toList', []));
  };
